...
public class Acct_ChangeEmailGUI extends javax.swing.JFrame {
    private int libacct_id;
    /**
     * Creates new form ChangeEmailGUI
     */
    public Acct_ChangeEmailGUI() {
        initComponents();
    }
    public Acct_ChangeEmailGUI(int id) {
        initComponents();
        this.libacct_id = id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Acct_ChangeEmailGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Acct_ChangeEmailGUI().setVisible(true);
            }
        });
    }
